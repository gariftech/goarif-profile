    ...
    <div className="py-20 bg-gradient-to-br from-indigo-100 via-purple-100 to-gray-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">Innovate your data handling strategies</h2>
          <p className="text-xl text-gray-600 mb-10">Whether you’re solving business challenges or conducting groundbreaking research, Arif is here to help you every step of the way. </p>
